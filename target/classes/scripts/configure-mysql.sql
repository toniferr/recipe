...
CREATE USER 'recipe_dev_user'@'localhost' IDENTIFIED BY 'toni';
CREATE USER 'recipe_prod_user'@'localhost' IDENTIFIED BY 'toni';
CREATE USER 'recipe_dev_user'@'%' IDENTIFIED BY 'toni';
CREATE USER 'recipe_prod_user'@'%' IDENTIFIED BY 'toni';
